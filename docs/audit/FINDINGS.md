...
- [x] ERR-12 | medium | stuck-state | fixed:PENDING | 09-error-handling.md | Trigger failure after a landed commit: honest-but-dead-end half state, and spawn timeouts are indistinguishable from exit-1
