...
| AGENTS.md (operating contract for AI coding agents: session protocol, task-specific reading, validation, safety, and handoff) | [AGENTS.md](../AGENTS.md) | **Exists** (root fundamental) — a concise routing layer: it names the minimum orientation set, points task classes to their canonical homes, and records repository-wide refusals that apply across tools |
